...
BEGIN TRANSACTION;
    ...
    --- 10.
    INSERT INTO @id (ID) EXECUTE Feedback.Create_Question @Event_ID=@Template_ID, @Question=N'Feedback to the presenter', @Description='Remember to make your feedback actionable and specific.', @Is_required=0, @Has_plaintext=8, @Type='text', @Display_order=10;
